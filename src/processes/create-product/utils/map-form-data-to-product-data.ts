import { productCategoryIdInputName, productDescriptionInputName, productNameInputName, productImagesInputName, productPriceInputName, productKeywordsInputName, productInfoInputName } from "../constants"
...
export function mapFormDataToProductData(formData: FormData): ProductData {
  ...
  const productInfo = JSON.parse(formData.get(productInfoInputName) as string || '')
